...
WIS_EXTERN_C WisResult wisDX12CreateInstance(
    bool debug_layer,
...
// wis::DX12Factory
// wis::ImplDX12CreateFactory(wis::Result& res, bool enable_debug, DX12FactoryExtension** extensions, size_t
...
//
//     auto hr = factory->EnumAdapterByGpuPreference(index, wis::detail::DX12Convert(preference),
//     internal.adapter.iid(),
