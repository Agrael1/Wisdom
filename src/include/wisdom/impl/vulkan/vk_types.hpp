...
#include <wisdom/impl/vulkan/vk_detail.hpp>
...
struct VKInstanceImpl {
    VkInstance                                       instance;
    detail::control_block<detail::VKInstanceHeader>* shared_header;
};
...
struct VKDeviceImpl {
    ...
    detail::control_block<detail::VKDeviceHeader>* device_header;
};
