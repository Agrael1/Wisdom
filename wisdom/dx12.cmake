...
if (WISDOM_CPP_MODULES_SUPPORTED)
  ...
  set_target_properties(wisdom-dx12-module PROPERTIES CXX_STANDARD 20 CXX_SCAN_FOR_MODULES ON)
endif()
...
if (WISDOM_CPP_MODULES_SUPPORTED)
  install(TARGETS wisdom-dx12-module
    EXPORT wisdom-dx12-module-targets
    RUNTIME DESTINATION ${CMAKE_INSTALL_BINDIR}
    LIBRARY DESTINATION ${CMAKE_INSTALL_LIBDIR}
    ARCHIVE DESTINATION ${CMAKE_INSTALL_LIBDIR}
  ...
  install(
    ...
    NAMESPACE wis::
    FILE wisdom-dx12-module-targets.cmake # Not sure if this is still needed
  )
endif()
