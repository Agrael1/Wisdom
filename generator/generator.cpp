...
int Generator::GenerateCAPI() {
  ...
  std::string generator_string = wis::format("// Generated by wisdom generator on {}\n", local);

  std::string output =
      generator_string + "#pragma once\n#include <stdint.h>\n#include <stdbool.h>\n\n";
  ...
  std::string output_cpp =
      generator_string + "#include \"wisdom.h\"\n#include <wisdom/wisdom.hpp>\n\n";
...
int Generator::GenerateCPPAPI() {
  using namespace std::chrono;
  auto local = zoned_time{current_zone(), system_clock::now()};
  std::string generator_string; //= wis::format("// Generated by wisdom
                                // generator on {}\n", local);

  std::string output_api = generator_string + "#pragma once\n#include <array>\n\n";
  ...
  if (func.return_types.size() <= 1) {
    if (func.return_types[0].type_info == TypeInfo::Handle) {
      return st_decl + wis::format("    return reinterpret_cast<{}>(new {}(std::move(ret)) }};\n",
                                   ...
                                   GetCPPFullTypename(func.return_types[0].type));
    }
