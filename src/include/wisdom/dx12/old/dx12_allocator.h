...
public:
    ...
    [[nodiscard]] WIS_INLINE wis::DX12Buffer CreateBuffer(
        wis::Result& result,
        uint64_t size,
    ...
    [[nodiscard]] WIS_INLINE DX12Texture CreateTexture(
        wis::Result& result,
    ...
    [[nodiscard]] WIS_INLINE wis::AllocationInfo GetBufferAllocationInfo(
        uint64_t size,
        BufferUsage flags = BufferUsage::None
    ) const noexcept;

    // Allocation functions
    [[nodiscard]] WIS_INLINE DX12Memory AllocateTextureMemory(
        wis::Result& result,
        uint64_t size,
    ...
    [[nodiscard]] WIS_INLINE DX12Memory AllocateBufferMemory(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
    ...
    [[nodiscard]] WIS_INLINE DX12Buffer PlaceBuffer(
        wis::Result& result,
        DX12MemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
        wis::BufferUsage usage
    ) const noexcept;

    [[nodiscard]] WIS_INLINE DX12Texture PlaceTexture(
        wis::Result& result,
        DX12MemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
...
public:
    ...
    [[nodiscard]] DX12Buffer CreateUploadBuffer(wis::Result& result, uint64_t size) const noexcept
    {
        return CreateBuffer(result, size, BufferUsage::CopySrc, MemoryType::Upload, wis::MemoryFlags::Mapped);
    }
    [[nodiscard]] DX12Buffer CreateReadbackBuffer(wis::Result& result, uint64_t size) const noexcept
    {
        return CreateBuffer(result, size, BufferUsage::CopyDst, MemoryType::Readback, wis::MemoryFlags::Mapped);
    }

public:
    [[nodiscard]] WIS_INLINE DX12Buffer DX12CreateResource(
        wis::Result& result,
    ...
    [[nodiscard]] WIS_INLINE wis::DX12Buffer DX12CreateResource2(
        wis::Result& result,
        const D3D12MA::ALLOCATION_DESC& all_desc,
        const D3D12_RESOURCE_DESC1& res_desc,
        D3D12_RESOURCE_STATES state
    ...
    WIS_INLINE static void DX12FillBufferDesc(uint64_t size, BufferUsage flags, D3D12_RESOURCE_DESC1& info) noexcept;

    WIS_INLINE static void DX12FillTextureDesc(const TextureDesc& desc, D3D12_RESOURCE_DESC1& info) noexcept;
};
...
public:
     ...
     * */
    [[nodiscard]] inline wis::DX12Buffer CreateBuffer(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
     ...
     * @return wis::DX12Buffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Buffer> CreateBuffer(
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::DX12Buffer>{
            &wis::ImplDX12ResourceAllocator::CreateBuffer,
            this,
            size,
            usage,
            memory,
     ...
     * */
    [[nodiscard]] inline wis::DX12Texture CreateTexture(
        wis::Result& result,
        const wis::TextureDesc& desc,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
     ...
     * @return wis::DX12Texture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Texture> CreateTexture(
        const wis::TextureDesc& desc,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ) const noexcept
    {
        return wis::ResultValue<wis::DX12Texture>{
     ...
     * */
    [[nodiscard]] inline wis::DX12Memory AllocateTextureMemory(
        wis::Result& result,
        uint64_t size,
        wis::TextureUsage usage,
     ...
     * @return wis::DX12Memory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Memory> AllocateTextureMemory(
        uint64_t size,
        wis::TextureUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::DX12Memory>{
            &wis::ImplDX12ResourceAllocator::AllocateTextureMemory,
            this,
            size,
            usage,
            mem_type,
     ...
     * @return wis::DX12Memory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::DX12Memory AllocateBufferMemory(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
     ...
     * @return wis::DX12Memory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Memory> AllocateBufferMemory(
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::DX12Memory>{
            &wis::ImplDX12ResourceAllocator::AllocateBufferMemory,
            this,
            size,
            usage,
            mem_type,
     ...
     * @return wis::DX12Buffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::DX12Buffer PlaceBuffer(
        wis::Result& result,
        wis::DX12MemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
        wis::BufferUsage usage
    ) const noexcept
     ...
     * @return wis::DX12Buffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Buffer> PlaceBuffer(
        wis::DX12MemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
        wis::BufferUsage usage
    ...
    {
        return wis::ResultValue<wis::DX12Buffer>{
            &wis::ImplDX12ResourceAllocator::PlaceBuffer,
            this,
            std::move(memory),
            memory_offset,
            size,
     ...
     * @return wis::DX12Texture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::DX12Texture PlaceTexture(
        wis::Result& result,
        wis::DX12MemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
     ...
     * @return wis::DX12Texture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12Texture> PlaceTexture(
        wis::DX12MemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
    ) const noexcept
    {
        return wis::ResultValue<wis::DX12Texture>{
            &wis::ImplDX12ResourceAllocator::PlaceTexture,
            this,
            std::move(memory),
            memory_offset,
            desc
