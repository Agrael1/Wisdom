 ...
 *
 * */
class DX12ViewHeap : public wis::impl::Implements<wis::impl::DX12ViewHeapImpl, WisDX12ViewHeap, wis::DX12ViewHeapDeleter>
{
public:
    using ImplType::ImplType;
...
public:
     ...
     *
     * */
    WIS_NODISCARD inline std::uint64_t WriteRenderTarget(wis::DX12TextureView         texture,
                                                         const wis::RenderTargetDesc& render_target,
                                                         std::uint32_t                index) const noexcept
    {
        return (::wisDX12ViewHeapWriteRenderTarget(&_impl_storage,
                                                   texture,
     ...
     *
     * */
    WIS_NODISCARD inline std::uint64_t WriteDepthStencil(wis::DX12TextureView         texture,
                                                         const wis::RenderTargetDesc& render_target,
                                                         std::uint32_t                index) const noexcept
    {
        return (::wisDX12ViewHeapWriteDepthStencil(&_impl_storage,
                                                   texture,
                                                   reinterpret_cast<const WisRenderTargetDesc*>(&render_target),
                                                   index));
    }
    ...
    {
        return (::wisDX12ViewHeapGetViewAddress(&_impl_storage,
                                                index));
    }
    /**
    ...
    {
        ::wisDX12ViewHeapCopyViews(&_impl_storage,
                                   dst_index,
                                   src_ptr,
                                   src_index,
                                   count);
...
public:
    ...
    {
        const WisResult wis_result = ::wisDX12PipelineCacheSerialize(&_impl_storage,
...
public:
    ...
    inline wis::Result WriteConstantBuffer(const wis::ConstantBufferBinding& data,
                                           std::uint32_t                     index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteConstantBuffer(&_impl_storage,
    ...
    inline wis::Result WriteStructuredBuffer(wis::DX12BufferView       buffer,
                                             ...
                                             std::uint32_t             index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteStructuredBuffer(&_impl_storage,
                                                                                  buffer,
    ...
    inline wis::Result WriteRWStructuredBuffer(wis::DX12BufferView       buffer,
                                               ...
                                               std::uint32_t             index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteRWStructuredBuffer(&_impl_storage,
                                                                                    buffer,
                                                                                    reinterpret_cast<const WisBufferBinding*>(&data),
                                                                                    index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteSampler(const wis::SamplerDesc& sampler,
                                    std::uint32_t           index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteSampler(&_impl_storage,
    ...
    inline wis::Result WriteTexture(wis::DX12TextureView       texture,
                                    ...
                                    std::uint32_t              index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteTexture(&_impl_storage,
                                                                         texture,
    ...
    inline wis::Result WriteRWTexture(wis::DX12TextureView       texture,
                                      ...
                                      std::uint32_t              index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteRWTexture(&_impl_storage,
                                                                           texture,
                                                                           reinterpret_cast<const WisTextureBinding*>(&data),
                                                                           index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteAccelerationStructure(std::uint64_t address,
                                                  std::uint32_t index) const noexcept
    {
        const WisResult wis_result = ::wisDX12DescriptorHeapWriteAccelerationStructure(&_impl_storage,
                                                                                       address,
                                                                                       index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline void CopyDescriptors(std::uint32_t dst_index,
                                ...
                                std::uint32_t count) const noexcept
    {
        ::wisDX12DescriptorHeapCopyDescriptors(&_impl_storage,
                                               dst_index,
                                               src_ptr,
                                               src_index,
                                               count);
...
public:
                                                      ...
                                                      wis::Result&           out_result) const noexcept
    {
        ...
        const WisResult wis_result = ::wisDX12ResourceAllocatorCreateBuffer(&_impl_storage,
                                                        ...
                                                        wis::Result&            out_result) const noexcept
    {
        ...
        const WisResult  wis_result = ::wisDX12ResourceAllocatorCreateTexture(&_impl_storage,
...
public:
    ...
    {
        const WisResult wis_result = ::wisDX12FenceWait(&_impl_storage,
                                                        value,
                                                        wait_ns);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    {
        const WisResult wis_result = ::wisDX12FenceSignal(&_impl_storage,
                                                          value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
};
...
public:
    ...
    {
        const WisResult wis_result = ::wisDX12CommandQueueSubmit(&_impl_storage,
    ...
    {
        const WisResult wis_result = ::wisDX12CommandQueueSignalFence(&_impl_storage,
                                                                      fence,
                                                                      value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline wis::Result WaitFence(wis::DX12FenceView fence,
                                 std::uint64_t      value) const noexcept
    {
        const WisResult wis_result = ::wisDX12CommandQueueWaitFence(&_impl_storage,
                                                                    fence,
                                                                    value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
...
public:
                                                                  ...
                                                                  wis::Result&          out_result) const noexcept
    {
        ...
        const WisResult       wis_result = ::wisDX12DeviceCreateCommandQueue(&_impl_storage,
                                                                          ...
                                                                          wis::Result&          out_result) const noexcept
    {
        ...
        const WisResult           wis_result = ::wisDX12DeviceCreateCommandAllocator(&_impl_storage,
                                                                           static_cast<WisCommandQueueType>(type),
    ...
    {
        wis::DX12Fence  fence;
        const WisResult wis_result = ::wisDX12DeviceCreateFence(&_impl_storage,
                                                                initial_value,
                                                                fence.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return fence;
                                                                    ...
                                                                    wis::Result&                  out_result) const noexcept
    {
        ...
        const WisResult        wis_result = ::wisDX12DeviceCreateRootSignature(&_impl_storage,
                                                                      ...
                                                                      wis::Result&                   out_result) const noexcept
    {
        ...
        const WisResult         wis_result = ::wisDX12DeviceCreateDescriptorHeap(&_impl_storage,
     ...
     *
     * */
    WIS_NODISCARD inline wis::DX12ViewHeap CreateViewHeap(wis::ViewHeapType type,
                                                          std::uint32_t     capacity,
                                                          wis::Result&      out_result) const noexcept
    {
        wis::DX12ViewHeap heap;
        const WisResult   wis_result = ::wisDX12DeviceCreateViewHeap(&_impl_storage,
    ...
    {
        const WisResult wis_result = ::wisDX12DeviceWaitForMultipleFences(&_impl_storage,
                                                                          fences,
                                                                          fence_values,
                                                                          fence_count,
                                                                    ...
                                                                    wis::Result&                  out_result) const noexcept
    {
        ...
        const WisResult        wis_result = ::wisDX12DeviceCreatePipelineCache(&_impl_storage,
                                                      ...
                                                      wis::Result&                  out_result) const noexcept
    {
        ...
        const WisResult wis_result = ::wisDX12DeviceCreateShader(&_impl_storage,
                                                                 ...
                                                                 wis::Result&                        out_result) const noexcept
    {
        ...
        const WisResult   wis_result = ::wisDX12DeviceCreateComputePipeline(&_impl_storage,
    ...
    {
        wis::DX12Pipeline pipeline;
        const WisResult   wis_result = ::wisDX12DeviceCreateGraphicsPipeline(&_impl_storage,
...
public:
                                                         ...
                                                         wis::Result& out_result) const noexcept
    {
        ...
        const WisResult  wis_result = ::wisDX12AdapterQueryGetAdapterDesc(&_impl_storage,
                                                                         index,
                                                      ...
                                                      wis::Result&                       out_result) const noexcept
    {
        ...
        const WisResult wis_result = ::wisDX12AdapterQueryCreateDevice(&_impl_storage,
                                                                       index,
...
public:
                                                             ...
                                                             wis::Result&           out_result) const noexcept
    {
        ...
        const WisResult       wis_result = ::wisDX12InstanceQueryAdapters(&_impl_storage,
...
public:
    ...
    inline wis::Result Serialize(wis::span<std::uint8_t> data) const noexcept
    {
        const WisResult wis_result = ::wisVKPipelineCacheSerialize(&_impl_storage,
                                                                   reinterpret_cast<uint8_t*>(data.data()),
                                                                   data.size());
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
...
public:
    ...
    inline wis::Result WriteConstantBuffer(const wis::ConstantBufferBinding& data,
                                           std::uint32_t                     index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteConstantBuffer(&_impl_storage,
                                                                              reinterpret_cast<const WisConstantBufferBinding*>(&data),
                                                                              index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline wis::Result WriteStructuredBuffer(wis::VKBufferView         buffer,
                                             ...
                                             std::uint32_t             index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteStructuredBuffer(&_impl_storage,
                                                                                buffer,
                                                                                reinterpret_cast<const WisBufferBinding*>(&data),
                                                                                index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteRWStructuredBuffer(wis::VKBufferView         buffer,
                                               ...
                                               std::uint32_t             index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteRWStructuredBuffer(&_impl_storage,
                                                                                  buffer,
                                                                                  reinterpret_cast<const WisBufferBinding*>(&data),
                                                                                  index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteSampler(const wis::SamplerDesc& sampler,
                                    std::uint32_t           index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteSampler(&_impl_storage,
                                                                       reinterpret_cast<const WisSamplerDesc*>(&sampler),
                                                                       index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline wis::Result WriteTexture(wis::VKTextureView         texture,
                                    ...
                                    std::uint32_t              index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteTexture(&_impl_storage,
                                                                       texture,
                                                                       reinterpret_cast<const WisTextureBinding*>(&data),
                                                                       index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteRWTexture(wis::VKTextureView         texture,
                                      ...
                                      std::uint32_t              index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteRWTexture(&_impl_storage,
                                                                         texture,
                                                                         reinterpret_cast<const WisTextureBinding*>(&data),
                                                                         index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WriteAccelerationStructure(std::uint64_t address,
                                                  std::uint32_t index) const noexcept
    {
        const WisResult wis_result = ::wisVKDescriptorHeapWriteAccelerationStructure(&_impl_storage,
                                                                                     address,
                                                                                     index);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
...
public:
    ...
    {
        wis::VKBuffer   buffer;
        const WisResult wis_result = ::wisVKResourceAllocatorCreateBuffer(&_impl_storage,
                                                                          reinterpret_cast<const WisBufferDesc*>(&desc),
                                                                          buffer.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return buffer;
                                                      ...
                                                      wis::Result&            out_result) const noexcept
    {
        ...
        const WisResult wis_result = ::wisVKResourceAllocatorCreateTexture(&_impl_storage,
                                                                           reinterpret_cast<const WisTextureDesc*>(&desc),
                                                                           static_cast<WisTextureState>(initial_state),
                                                                           texture.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
...
public:
    ...
    inline wis::Result Wait(std::uint64_t value,
                            std::uint64_t wait_ns) const noexcept
    {
        const WisResult wis_result = ::wisVKFenceWait(&_impl_storage,
                                                      value,
                                                      wait_ns);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline wis::Result Signal(std::uint64_t value) const noexcept
    {
        const WisResult wis_result = ::wisVKFenceSignal(&_impl_storage,
                                                        value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
};
...
public:
    ...
    {
        const WisResult wis_result = ::wisVKCommandQueueSubmit(&_impl_storage,
    ...
    inline wis::Result SignalFence(wis::VKFenceView fence,
                                   std::uint64_t    value) const noexcept
    {
        const WisResult wis_result = ::wisVKCommandQueueSignalFence(&_impl_storage,
                                                                    fence,
                                                                    value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
    ...
    inline wis::Result WaitFence(wis::VKFenceView fence,
                                 std::uint64_t    value) const noexcept
    {
        const WisResult wis_result = ::wisVKCommandQueueWaitFence(&_impl_storage,
                                                                  fence,
                                                                  value);
        return wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    }
...
public:
                                                                ...
                                                                wis::Result&          out_result) const noexcept
    {
        ...
        const WisResult     wis_result = ::wisVKDeviceCreateCommandQueue(&_impl_storage,
                                                                     static_cast<WisCommandQueueType>(type),
                                                                     queue.GetStorage());
        out_result                     = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return queue;
                                                                        ...
                                                                        wis::Result&          out_result) const noexcept
    {
        ...
        const WisResult         wis_result = ::wisVKDeviceCreateCommandAllocator(&_impl_storage,
                                                                         static_cast<WisCommandQueueType>(type),
                                                                         allocator.GetStorage());
        out_result                         = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return allocator;
    ...
    {
        wis::VKFence    fence;
        const WisResult wis_result = ::wisVKDeviceCreateFence(&_impl_storage,
                                                              initial_value,
                                                              fence.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return fence;
                                                                  ...
                                                                  wis::Result&                  out_result) const noexcept
    {
        ...
        const WisResult      wis_result = ::wisVKDeviceCreateRootSignature(&_impl_storage,
                                                                      reinterpret_cast<const WisRootSignatureDesc*>(&desc),
                                                                      layout.GetStorage());
        out_result                      = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return layout;
                                                                    ...
                                                                    wis::Result&                   out_result) const noexcept
    {
        ...
        const WisResult       wis_result = ::wisVKDeviceCreateDescriptorHeap(&_impl_storage,
                                                                       reinterpret_cast<const WisDescriptorHeapDesc*>(&desc),
                                                                       heap.GetStorage());
        out_result                       = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return heap;
    ...
    {
        wis::VKViewHeap heap;
        const WisResult wis_result = ::wisVKDeviceCreateViewHeap(&_impl_storage,
                                                                 static_cast<WisViewHeapType>(type),
                                                                 capacity,
                                                                 heap.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    inline wis::Result WaitForMultipleFences(const wis::VKFenceView* fences,
                                             ...
                                             std::uint64_t           timeout) const noexcept
    {
        const WisResult wis_result = ::wisVKDeviceWaitForMultipleFences(&_impl_storage,
                                                                        fences,
                                                                        fence_values,
                                                                        fence_count,
                                                                        static_cast<WisMutiWaitType>(wait_for),
                                                                  ...
                                                                  wis::Result&                  out_result) const noexcept
    {
        ...
        const WisResult      wis_result = ::wisVKDeviceCreatePipelineCache(&_impl_storage,
                                                                      reinterpret_cast<const uint8_t*>(initial_data.data()),
                                                                      initial_data.size(),
                                                                      cache.GetStorage());
        out_result                      = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
    ...
    {
        wis::VKShader   shader;
        const WisResult wis_result = ::wisVKDeviceCreateShader(&_impl_storage,
                                                               reinterpret_cast<const uint8_t*>(data.data()),
                                                               data.size(),
                                                               shader.GetStorage());
        out_result                 = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
                                                               ...
                                                               wis::Result&                      out_result) const noexcept
    {
        ...
        const WisResult wis_result = ::wisVKDeviceCreateComputePipeline(&_impl_storage,
    ...
    {
        wis::VKPipeline pipeline;
        const WisResult wis_result = ::wisVKDeviceCreateGraphicsPipeline(&_impl_storage,
...
public:
    ...
    {
        wis::AdapterDesc desc;
        const WisResult  wis_result = ::wisVKAdapterQueryGetAdapterDesc(&_impl_storage,
                                                                       index,
                                                                       reinterpret_cast<WisAdapterDesc*>(&desc));
        out_result                  = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return desc;
    ...
    {
        wis::VKDevice   device;
        const WisResult wis_result = ::wisVKAdapterQueryCreateDevice(&_impl_storage,
                                                                     index,
...
public:
                                                           ...
                                                           wis::Result&           out_result) const noexcept
    {
        ...
        const WisResult     wis_result = ::wisVKInstanceQueryAdapters(&_impl_storage,
                                                                  static_cast<WisAdapterPreference>(preference),
                                                                  query.GetStorage());
        out_result                     = wis::Result{ static_cast<wis::Status>(wis_result.status), wis_result.platform_code, wis_result.error };
        return query;
