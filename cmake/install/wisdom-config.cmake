...
target_compile_definitions(wis::wisdom-platform-headers INTERFACE 
    $<$<BOOL:${WISDOM_PLATFORM_WIN32_AVAILABLE}>:WIS_PLATFORM_WIN32_PRESENT=1>
    $<$<BOOL:${WISDOM_PLATFORM_WIN32_AVAILABLE}>:WISDOM_PLATFORM_UWP_PRESENT=1>
    $<$<BOOL:${WISDOM_PLATFORM_XLIB_AVAILABLE}>:WISDOM_PLATFORM_XLIB_PRESENT=1>
    $<$<BOOL:${WISDOM_PLATFORM_XCB_AVAILABLE}>:WISDOM_PLATFORM_XCB_PRESENT=1>
    $<$<BOOL:${WISDOM_PLATFORM_WAYLAND_AVAILABLE}>:WISDOM_PLATFORM_WAYLAND_PRESENT=1>
)
endif()
endif()
