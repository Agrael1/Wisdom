 ...
 * - `start_index` The index of the first index to draw. Default is 0.
 * - `base_vertex` The value added to each index before reading a vertex from the vertex buffer. Default is 0.
