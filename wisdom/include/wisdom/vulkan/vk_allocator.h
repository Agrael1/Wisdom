...
public:
    ...
    {
        return wis::ImplVKResourceAllocator::PlaceBuffer(memory, memory_offset, size, usage);
    }
    /**
    ...
    {
        return wis::ImplVKResourceAllocator::PlaceTexture(memory, memory_offset, desc);
    }
};
