 ...
 * - `WisCompareOperationLessEqual = 4`: Pass the comparison if the source value is less than or equal to the
 * destination value.
 ...
 * - `WisCompareOperationGreaterEqual = 7`: Pass the comparison if the source value is greater than or equal to the
 * destination value.
