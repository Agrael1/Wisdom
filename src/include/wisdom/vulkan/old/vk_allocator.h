...
public:
    ...
    [[nodiscard]] WIS_INLINE wis::VKBuffer CreateBuffer(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ) const noexcept;

    [[nodiscard]] WIS_INLINE wis::VKTexture CreateTexture(
        wis::Result& result,
    ...
    [[nodiscard]] WIS_INLINE wis::AllocationInfo GetTextureAllocationInfo(const wis::TextureDesc& desc) const noexcept;

    [[nodiscard]] WIS_INLINE wis::AllocationInfo GetBufferAllocationInfo(
        uint64_t size,
        wis::BufferUsage usage
    ) const noexcept;

    // Allocation functions
    [[nodiscard]] WIS_INLINE wis::VKMemory AllocateTextureMemory(
        wis::Result& result,
        uint64_t size,
    ...
    [[nodiscard]] WIS_INLINE wis::VKMemory AllocateBufferMemory(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
    ...
    [[nodiscard]] WIS_INLINE wis::VKBuffer PlaceBuffer(
        wis::Result& result,
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
        wis::BufferUsage usage
    ) const noexcept;

    [[nodiscard]] WIS_INLINE wis::VKTexture PlaceTexture(
        wis::Result& result,
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
...
public:
    ...
    [[nodiscard]] wis::VKBuffer CreateUploadBuffer(wis::Result& result, uint64_t size) const noexcept
    {
        return CreateBuffer(result, size, BufferUsage::CopySrc, MemoryType::Upload, wis::MemoryFlags::Mapped);
    }
    [[nodiscard]] wis::VKBuffer CreateReadbackBuffer(wis::Result& result, uint64_t size) const noexcept
    {
        return CreateBuffer(result, size, BufferUsage::CopyDst, MemoryType::Readback, wis::MemoryFlags::Mapped);
    }

public:
    [[nodiscard]] WIS_INLINE wis::VKBuffer VKCreateBuffer(
        wis::Result& result,
        VkBufferCreateInfo& desc,
        const VmaAllocationCreateInfo& alloc_desc,
        bool interop = false
    ) const noexcept;

    [[nodiscard]] WIS_INLINE wis::VKTexture VKCreateTexture(
        wis::Result& result,
    ...
    [[nodiscard]] WIS_INLINE wis::VKBuffer VKCreateAliasingBuffer(
        wis::Result& result,
        VkBufferCreateInfo& desc,
        VkDeviceSize offset,
        VmaAllocation alloc,
    ...
    [[nodiscard]] WIS_INLINE wis::VKTexture VKCreateAliasingTexture(
        wis::Result& result,
        VkImageCreateInfo& desc,
        VkDeviceSize offset,
        VmaAllocation alloc,
    ...
    WIS_INLINE static void VKFillBufferDesc(uint64_t size, BufferUsage flags, VkBufferCreateInfo& info) noexcept;

    WIS_INLINE static void VKFillImageDesc(const TextureDesc& desc, VkImageCreateInfo& info) noexcept;

    WIS_INLINE void VKFillTextureAllocationInfo(
        const wis::TextureDesc& desc,
        VkMemoryRequirements2& out_info
    ) const noexcept;

    WIS_INLINE void VKFillBufferAllocationInfo(
        uint64_t size,
        wis::BufferUsage flags,
        VkMemoryRequirements2& out_info
    ) const noexcept;
};
...
public:
     ...
     * */
    [[nodiscard]] inline wis::VKBuffer CreateBuffer(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
     ...
     * @return wis::VKBuffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKBuffer> CreateBuffer(
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::VKBuffer>{
            &wis::ImplVKResourceAllocator::CreateBuffer,
            this,
            size,
            usage,
            memory,
     ...
     * */
    [[nodiscard]] inline wis::VKTexture CreateTexture(
        wis::Result& result,
        const wis::TextureDesc& desc,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
     ...
     * @return wis::VKTexture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKTexture> CreateTexture(
        const wis::TextureDesc& desc,
        wis::MemoryType memory = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ) const noexcept
    {
        return wis::ResultValue<wis::VKTexture>{
            &wis::ImplVKResourceAllocator::CreateTexture,
            this,
            desc,
            memory,
            mem_flags
     ...
     * */
    [[nodiscard]] inline wis::VKMemory AllocateTextureMemory(
        wis::Result& result,
        uint64_t size,
        wis::TextureUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ) const noexcept
    {
     ...
     * @return wis::VKMemory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKMemory> AllocateTextureMemory(
        uint64_t size,
        wis::TextureUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::VKMemory>{
            &wis::ImplVKResourceAllocator::AllocateTextureMemory,
            this,
            size,
            usage,
            mem_type,
     ...
     * @return wis::VKMemory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::VKMemory AllocateBufferMemory(
        wis::Result& result,
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
     ...
     * @return wis::VKMemory on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKMemory> AllocateBufferMemory(
        uint64_t size,
        wis::BufferUsage usage,
        wis::MemoryType mem_type = wis::MemoryType::Default,
        wis::MemoryFlags mem_flags = wis::MemoryFlags::None
    ...
    {
        return wis::ResultValue<wis::VKMemory>{
            &wis::ImplVKResourceAllocator::AllocateBufferMemory,
            this,
            size,
            usage,
            mem_type,
     ...
     * @return wis::VKBuffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::VKBuffer PlaceBuffer(
        wis::Result& result,
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
     ...
     * @return wis::VKBuffer on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKBuffer> PlaceBuffer(
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        uint64_t size,
        wis::BufferUsage usage
    ...
    {
        return wis::ResultValue<wis::VKBuffer>{
            &wis::ImplVKResourceAllocator::PlaceBuffer,
            this,
            std::move(memory),
            memory_offset,
            size,
     ...
     * @return wis::VKTexture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::VKTexture PlaceTexture(
        wis::Result& result,
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
     ...
     * @return wis::VKTexture on success (wis::Status::Ok).
     * */
    [[nodiscard]] inline wis::ResultValue<wis::VKTexture> PlaceTexture(
        wis::VKMemoryView memory,
        uint64_t memory_offset,
        const wis::TextureDesc& desc
    ) const noexcept
    {
        return wis::ResultValue<wis::VKTexture>{
            &wis::ImplVKResourceAllocator::PlaceTexture,
            this,
            std::move(memory),
            memory_offset,
            desc
