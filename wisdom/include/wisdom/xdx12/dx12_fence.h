...
struct unique_event {
  unique_event() noexcept : hevent(CreateEventW(nullptr, false, false, nullptr)) {}
  unique_event(unique_event const&) = delete;
  unique_event& operator=(unique_event const&) = delete;
  unique_event(unique_event&& o) noexcept : hevent(std::exchange(o.hevent, nullptr)) {}
...
template <> class Internal<DX12Fence> {
public:
