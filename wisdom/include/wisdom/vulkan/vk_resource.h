...
public:
    VKBuffer() = default;
    explicit VKBuffer(wis::shared_handle<vk::Buffer> buffer, wis::shared_handle<VmaAllocation> allocation, size_t size) noexcept
...
public:
    VKTexture() = default;
    explicit VKTexture(vk::Format format, wis::shared_handle<vk::Image> buffer, wis::shared_handle<VmaAllocation> allocation = {}) noexcept
