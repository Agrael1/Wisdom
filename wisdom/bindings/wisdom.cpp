// Generated by wisdom generator on 2024-04-02 22:24:22.6893193 GMT+2
#include "wisdom.h"
...
{
    auto* xself = reinterpret_cast<wis::DX12UploadBuffer*>(self);
    delete xself;
}
void VKUploadBufferDestroy(VKUploadBuffer self)
{
    auto* xself = reinterpret_cast<wis::VKUploadBuffer*>(self);
    delete xself;
}
