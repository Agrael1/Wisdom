...
wis::VKTexture
wis::ImplVKExtendedAllocation::CreateGPUUploadTexture(wis::Result& result, const wis::VKResourceAllocator& allocator, wis::TextureDesc desc, wis::TextureState initial_state, wis::MemoryFlags flags) const noexcept
{
    auto synth_1 = [this](wis::Result& result, const wis::VKResourceAllocator& allocator, wis::TextureDesc desc, wis::TextureState initial_state, wis::MemoryFlags flags) {
