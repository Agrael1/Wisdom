...
wis::VKMemory
wis::ImplVKResourceAllocator::AllocateTextureMemory(wis::Result& result, uint64_t size, wis::TextureUsage usage, wis::MemoryType memory, wis::MemoryFlags mem_flags) const noexcept
{
    VKMemory out_mem;
...
wis::VKMemory
wis::ImplVKResourceAllocator::AllocateBufferMemory(wis::Result& result, uint64_t size, wis::BufferUsage usage, wis::MemoryType memory, wis::MemoryFlags mem_flags) const noexcept
{
    VKMemory out_mem;
    auto&    internal = out_mem.GetMutableInternal();
