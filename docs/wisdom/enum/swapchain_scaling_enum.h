 ...
 *
 * \note Translates to  `DXGI_SCALING` for DirectX 12 implementation, and `VkPresentScalingFlagsEXT` for Vulkan
 * implementation.
 *
 * Values:
 ...
 * - `WisSwapchainScalingAspect = 2`: Aspect scaling. The swapchain size is scaled to the window size with aspect ratio
 * preserved. \endcond
 *
 *
