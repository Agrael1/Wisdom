...
{
    return reinterpret_cast<DX12BufferView&>(static_cast<wis::DX12BufferView>(reinterpret_cast<wis::DX12Buffer&>(*self)));
}
VKBufferView AsVKBufferView(VKBuffer self)
{
    return reinterpret_cast<VKBufferView&>(static_cast<wis::VKBufferView>(reinterpret_cast<wis::VKBuffer&>(*self)));
}
DX12TextureView AsDX12TextureView(DX12Texture self)
{
    return reinterpret_cast<DX12TextureView&>(static_cast<wis::DX12TextureView>(reinterpret_cast<wis::DX12Texture&>(*self)));
}
VKTextureView AsVKTextureView(VKTexture self)
{
    return reinterpret_cast<VKTextureView&>(static_cast<wis::VKTextureView>(reinterpret_cast<wis::VKTexture&>(*self)));
}
...
{
    return reinterpret_cast<DX12RenderTargetView&>(static_cast<wis::DX12RenderTargetView>(reinterpret_cast<wis::DX12RenderTarget&>(*self)));
}
VKRenderTargetView AsVKRenderTargetView(VKRenderTarget self)
{
    return reinterpret_cast<VKRenderTargetView&>(static_cast<wis::VKRenderTargetView>(reinterpret_cast<wis::VKRenderTarget&>(*self)));
}
...
{
    return reinterpret_cast<DX12DescriptorBufferView&>(static_cast<wis::DX12DescriptorBufferView>(reinterpret_cast<wis::DX12DescriptorBuffer&>(*self)));
}
VKDescriptorBufferView AsVKDescriptorBufferView(VKDescriptorBuffer self)
{
    return reinterpret_cast<VKDescriptorBufferView&>(static_cast<wis::VKDescriptorBufferView>(reinterpret_cast<wis::VKDescriptorBuffer&>(*self)));
}
...
{
    auto&& ret = wis::DX12CreateDevice(*reinterpret_cast<wis::Adapter*>(adapter));
    bool ok = std::get<0>(ret).status == wis::Status::Success;
...
{
    auto&& ret = wis::VKCreateDevice(*reinterpret_cast<wis::Adapter*>(adapter));
    bool ok = std::get<0>(ret).status == wis::Status::Success;
