...
public:
    bool Init(LibTokenView token) noexcept {
        ...
        if(vkEnumerateInstanceLayerProperties == nullptr) return false;
        ...
        if(vkCreateInstance == nullptr) return false;
...
public:
    bool Init(VkInstance instance, PFN_vkGetInstanceProcAddr vkGetInstanceProcAddr) noexcept {
        ...
        if(vkGetPhysicalDeviceMemoryProperties == nullptr) return false;
        vkDestroyInstance = (PFN_vkDestroyInstance)vkGetInstanceProcAddr(instance, "vkDestroyInstance");
        if(vkDestroyInstance == nullptr) return false;
        vkCreateDevice = (PFN_vkCreateDevice)vkGetInstanceProcAddr(instance, "vkCreateDevice");
        if(vkCreateDevice == nullptr) return false;
        vkGetPhysicalDeviceProperties = (PFN_vkGetPhysicalDeviceProperties)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceProperties");
        if(vkGetPhysicalDeviceProperties == nullptr) return false;
        vkEnumeratePhysicalDevices = (PFN_vkEnumeratePhysicalDevices)vkGetInstanceProcAddr(instance, "vkEnumeratePhysicalDevices");
        if(vkEnumeratePhysicalDevices == nullptr) return false;
        vkGetPhysicalDeviceQueueFamilyProperties = (PFN_vkGetPhysicalDeviceQueueFamilyProperties)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceQueueFamilyProperties");
        if(vkGetPhysicalDeviceQueueFamilyProperties == nullptr) return false;
        vkEnumerateDeviceExtensionProperties = (PFN_vkEnumerateDeviceExtensionProperties)vkGetInstanceProcAddr(instance, "vkEnumerateDeviceExtensionProperties");
        if(vkEnumerateDeviceExtensionProperties == nullptr) return false;
        ...
        for(auto vkGetPhysicalDeviceFeatures2_it : vkGetPhysicalDeviceFeatures2_strings)
            if((vkGetPhysicalDeviceFeatures2 = (PFN_vkGetPhysicalDeviceFeatures2)vkGetInstanceProcAddr(instance, vkGetPhysicalDeviceFeatures2_it)))
                break;
        if(vkGetPhysicalDeviceFeatures2 == nullptr) return false;
        ...
        for(auto vkGetPhysicalDeviceProperties2_it : vkGetPhysicalDeviceProperties2_strings)
            if((vkGetPhysicalDeviceProperties2 = (PFN_vkGetPhysicalDeviceProperties2)vkGetInstanceProcAddr(instance, vkGetPhysicalDeviceProperties2_it)))
                break;
        if(vkGetPhysicalDeviceProperties2 == nullptr) return false;
        ...
        if(vkDestroySurfaceKHR == nullptr) return false;
        vkGetPhysicalDeviceSurfaceSupportKHR = (PFN_vkGetPhysicalDeviceSurfaceSupportKHR)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceSurfaceSupportKHR");
        if(vkGetPhysicalDeviceSurfaceSupportKHR == nullptr) return false;
        vkGetPhysicalDeviceSurfaceCapabilitiesKHR = (PFN_vkGetPhysicalDeviceSurfaceCapabilitiesKHR)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceSurfaceCapabilitiesKHR");
        if(vkGetPhysicalDeviceSurfaceCapabilitiesKHR == nullptr) return false;
        vkGetPhysicalDeviceSurfaceFormatsKHR = (PFN_vkGetPhysicalDeviceSurfaceFormatsKHR)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceSurfaceFormatsKHR");
        if(vkGetPhysicalDeviceSurfaceFormatsKHR == nullptr) return false;
        vkGetPhysicalDeviceSurfacePresentModesKHR = (PFN_vkGetPhysicalDeviceSurfacePresentModesKHR)vkGetInstanceProcAddr(instance, "vkGetPhysicalDeviceSurfacePresentModesKHR");
        if(vkGetPhysicalDeviceSurfacePresentModesKHR == nullptr) return false;
        return true;
    }
};
    ...
    bool Init(VkDevice device, PFN_vkGetDeviceProcAddr vkGetDeviceProcAddr) noexcept {
        ...
        for(auto vkCmdCopyImageToBuffer2_it : vkCmdCopyImageToBuffer2_strings)
            if((vkCmdCopyImageToBuffer2 = (PFN_vkCmdCopyImageToBuffer2)vkGetDeviceProcAddr(device, vkCmdCopyImageToBuffer2_it)))
                break;
        if(vkCmdCopyImageToBuffer2 == nullptr) return false;
        ...
        for(auto vkCmdCopyBufferToImage2_it : vkCmdCopyBufferToImage2_strings)
            if((vkCmdCopyBufferToImage2 = (PFN_vkCmdCopyBufferToImage2)vkGetDeviceProcAddr(device, vkCmdCopyBufferToImage2_it)))
                break;
        if(vkCmdCopyBufferToImage2 == nullptr) return false;
        vkUnmapMemory = (PFN_vkUnmapMemory)vkGetDeviceProcAddr(device, "vkUnmapMemory");
        if(vkUnmapMemory == nullptr) return false;
        vkDestroyDevice = (PFN_vkDestroyDevice)vkGetDeviceProcAddr(device, "vkDestroyDevice");
        if(vkDestroyDevice == nullptr) return false;
        vkBeginCommandBuffer = (PFN_vkBeginCommandBuffer)vkGetDeviceProcAddr(device, "vkBeginCommandBuffer");
        if(vkBeginCommandBuffer == nullptr) return false;
        vkQueueSubmit = (PFN_vkQueueSubmit)vkGetDeviceProcAddr(device, "vkQueueSubmit");
        if(vkQueueSubmit == nullptr) return false;
        vkCreateSampler = (PFN_vkCreateSampler)vkGetDeviceProcAddr(device, "vkCreateSampler");
        if(vkCreateSampler == nullptr) return false;
        vkFlushMappedMemoryRanges = (PFN_vkFlushMappedMemoryRanges)vkGetDeviceProcAddr(device, "vkFlushMappedMemoryRanges");
        if(vkFlushMappedMemoryRanges == nullptr) return false;
        vkAllocateMemory = (PFN_vkAllocateMemory)vkGetDeviceProcAddr(device, "vkAllocateMemory");
        if(vkAllocateMemory == nullptr) return false;
        vkCreateImage = (PFN_vkCreateImage)vkGetDeviceProcAddr(device, "vkCreateImage");
        if(vkCreateImage == nullptr) return false;
        vkCreateDescriptorSetLayout = (PFN_vkCreateDescriptorSetLayout)vkGetDeviceProcAddr(device, "vkCreateDescriptorSetLayout");
        if(vkCreateDescriptorSetLayout == nullptr) return false;
        vkFreeMemory = (PFN_vkFreeMemory)vkGetDeviceProcAddr(device, "vkFreeMemory");
        if(vkFreeMemory == nullptr) return false;
        vkMapMemory = (PFN_vkMapMemory)vkGetDeviceProcAddr(device, "vkMapMemory");
        if(vkMapMemory == nullptr) return false;
        vkDestroyDescriptorSetLayout = (PFN_vkDestroyDescriptorSetLayout)vkGetDeviceProcAddr(device, "vkDestroyDescriptorSetLayout");
        if(vkDestroyDescriptorSetLayout == nullptr) return false;
        vkInvalidateMappedMemoryRanges = (PFN_vkInvalidateMappedMemoryRanges)vkGetDeviceProcAddr(device, "vkInvalidateMappedMemoryRanges");
        if(vkInvalidateMappedMemoryRanges == nullptr) return false;
        vkCmdSetScissor = (PFN_vkCmdSetScissor)vkGetDeviceProcAddr(device, "vkCmdSetScissor");
        if(vkCmdSetScissor == nullptr) return false;
        vkBindBufferMemory = (PFN_vkBindBufferMemory)vkGetDeviceProcAddr(device, "vkBindBufferMemory");
        if(vkBindBufferMemory == nullptr) return false;
        vkBindImageMemory = (PFN_vkBindImageMemory)vkGetDeviceProcAddr(device, "vkBindImageMemory");
        if(vkBindImageMemory == nullptr) return false;
        vkGetBufferMemoryRequirements = (PFN_vkGetBufferMemoryRequirements)vkGetDeviceProcAddr(device, "vkGetBufferMemoryRequirements");
        if(vkGetBufferMemoryRequirements == nullptr) return false;
        vkCmdSetViewport = (PFN_vkCmdSetViewport)vkGetDeviceProcAddr(device, "vkCmdSetViewport");
        if(vkCmdSetViewport == nullptr) return false;
        vkDestroySampler = (PFN_vkDestroySampler)vkGetDeviceProcAddr(device, "vkDestroySampler");
        if(vkDestroySampler == nullptr) return false;
        vkDestroyImageView = (PFN_vkDestroyImageView)vkGetDeviceProcAddr(device, "vkDestroyImageView");
        if(vkDestroyImageView == nullptr) return false;
        vkGetImageMemoryRequirements = (PFN_vkGetImageMemoryRequirements)vkGetDeviceProcAddr(device, "vkGetImageMemoryRequirements");
        if(vkGetImageMemoryRequirements == nullptr) return false;
        vkCreateFence = (PFN_vkCreateFence)vkGetDeviceProcAddr(device, "vkCreateFence");
        if(vkCreateFence == nullptr) return false;
        vkDestroyFence = (PFN_vkDestroyFence)vkGetDeviceProcAddr(device, "vkDestroyFence");
        if(vkDestroyFence == nullptr) return false;
        vkCreateCommandPool = (PFN_vkCreateCommandPool)vkGetDeviceProcAddr(device, "vkCreateCommandPool");
        if(vkCreateCommandPool == nullptr) return false;
        vkCmdBindPipeline = (PFN_vkCmdBindPipeline)vkGetDeviceProcAddr(device, "vkCmdBindPipeline");
        if(vkCmdBindPipeline == nullptr) return false;
        vkResetFences = (PFN_vkResetFences)vkGetDeviceProcAddr(device, "vkResetFences");
        if(vkResetFences == nullptr) return false;
        vkWaitForFences = (PFN_vkWaitForFences)vkGetDeviceProcAddr(device, "vkWaitForFences");
        if(vkWaitForFences == nullptr) return false;
        vkCreateSemaphore = (PFN_vkCreateSemaphore)vkGetDeviceProcAddr(device, "vkCreateSemaphore");
        if(vkCreateSemaphore == nullptr) return false;
        vkDestroyBuffer = (PFN_vkDestroyBuffer)vkGetDeviceProcAddr(device, "vkDestroyBuffer");
        if(vkDestroyBuffer == nullptr) return false;
        vkDestroySemaphore = (PFN_vkDestroySemaphore)vkGetDeviceProcAddr(device, "vkDestroySemaphore");
        if(vkDestroySemaphore == nullptr) return false;
        vkCreateBuffer = (PFN_vkCreateBuffer)vkGetDeviceProcAddr(device, "vkCreateBuffer");
        if(vkCreateBuffer == nullptr) return false;
        vkDestroyImage = (PFN_vkDestroyImage)vkGetDeviceProcAddr(device, "vkDestroyImage");
        if(vkDestroyImage == nullptr) return false;
        vkCreatePipelineLayout = (PFN_vkCreatePipelineLayout)vkGetDeviceProcAddr(device, "vkCreatePipelineLayout");
        if(vkCreatePipelineLayout == nullptr) return false;
        vkCreateImageView = (PFN_vkCreateImageView)vkGetDeviceProcAddr(device, "vkCreateImageView");
        if(vkCreateImageView == nullptr) return false;
        vkCreateShaderModule = (PFN_vkCreateShaderModule)vkGetDeviceProcAddr(device, "vkCreateShaderModule");
        if(vkCreateShaderModule == nullptr) return false;
        vkDestroyShaderModule = (PFN_vkDestroyShaderModule)vkGetDeviceProcAddr(device, "vkDestroyShaderModule");
        if(vkDestroyShaderModule == nullptr) return false;
        vkCmdBindIndexBuffer = (PFN_vkCmdBindIndexBuffer)vkGetDeviceProcAddr(device, "vkCmdBindIndexBuffer");
        if(vkCmdBindIndexBuffer == nullptr) return false;
        vkCreateGraphicsPipelines = (PFN_vkCreateGraphicsPipelines)vkGetDeviceProcAddr(device, "vkCreateGraphicsPipelines");
        if(vkCreateGraphicsPipelines == nullptr) return false;
        vkDestroyPipeline = (PFN_vkDestroyPipeline)vkGetDeviceProcAddr(device, "vkDestroyPipeline");
        if(vkDestroyPipeline == nullptr) return false;
        vkResetCommandBuffer = (PFN_vkResetCommandBuffer)vkGetDeviceProcAddr(device, "vkResetCommandBuffer");
        if(vkResetCommandBuffer == nullptr) return false;
        vkDestroyPipelineLayout = (PFN_vkDestroyPipelineLayout)vkGetDeviceProcAddr(device, "vkDestroyPipelineLayout");
        if(vkDestroyPipelineLayout == nullptr) return false;
        vkDestroyCommandPool = (PFN_vkDestroyCommandPool)vkGetDeviceProcAddr(device, "vkDestroyCommandPool");
        if(vkDestroyCommandPool == nullptr) return false;
        vkAllocateCommandBuffers = (PFN_vkAllocateCommandBuffers)vkGetDeviceProcAddr(device, "vkAllocateCommandBuffers");
        if(vkAllocateCommandBuffers == nullptr) return false;
        vkEndCommandBuffer = (PFN_vkEndCommandBuffer)vkGetDeviceProcAddr(device, "vkEndCommandBuffer");
        if(vkEndCommandBuffer == nullptr) return false;
        vkCmdDraw = (PFN_vkCmdDraw)vkGetDeviceProcAddr(device, "vkCmdDraw");
        if(vkCmdDraw == nullptr) return false;
        vkCmdDrawIndexed = (PFN_vkCmdDrawIndexed)vkGetDeviceProcAddr(device, "vkCmdDrawIndexed");
        if(vkCmdDrawIndexed == nullptr) return false;
        vkCmdCopyBuffer = (PFN_vkCmdCopyBuffer)vkGetDeviceProcAddr(device, "vkCmdCopyBuffer");
        if(vkCmdCopyBuffer == nullptr) return false;
        vkCmdPushConstants = (PFN_vkCmdPushConstants)vkGetDeviceProcAddr(device, "vkCmdPushConstants");
        if(vkCmdPushConstants == nullptr) return false;
        ...
        if(vkCmdSetDescriptorBufferOffsetsEXT == nullptr) return false;
        vkGetDescriptorEXT = (PFN_vkGetDescriptorEXT)vkGetDeviceProcAddr(device, "vkGetDescriptorEXT");
        if(vkGetDescriptorEXT == nullptr) return false;
        ...
        if(vkGetDescriptorSetLayoutSizeEXT == nullptr) return false;
        ...
        for(auto vkCmdBindVertexBuffers2_it : vkCmdBindVertexBuffers2_strings)
            if((vkCmdBindVertexBuffers2 = (PFN_vkCmdBindVertexBuffers2)vkGetDeviceProcAddr(device, vkCmdBindVertexBuffers2_it)))
                break;
        if(vkCmdBindVertexBuffers2 == nullptr) return false;
        ...
        for(auto vkCmdSetPrimitiveTopology_it : vkCmdSetPrimitiveTopology_strings)
            if((vkCmdSetPrimitiveTopology = (PFN_vkCmdSetPrimitiveTopology)vkGetDeviceProcAddr(device, vkCmdSetPrimitiveTopology_it)))
                break;
        if(vkCmdSetPrimitiveTopology == nullptr) return false;
        ...
        for(auto vkWaitSemaphores_it : vkWaitSemaphores_strings)
            if((vkWaitSemaphores = (PFN_vkWaitSemaphores)vkGetDeviceProcAddr(device, vkWaitSemaphores_it)))
                break;
        if(vkWaitSemaphores == nullptr) return false;
        ...
        for(auto vkSignalSemaphore_it : vkSignalSemaphore_strings)
            if((vkSignalSemaphore = (PFN_vkSignalSemaphore)vkGetDeviceProcAddr(device, vkSignalSemaphore_it)))
                break;
        if(vkSignalSemaphore == nullptr) return false;
        ...
        for(auto vkGetSemaphoreCounterValue_it : vkGetSemaphoreCounterValue_strings)
            if((vkGetSemaphoreCounterValue = (PFN_vkGetSemaphoreCounterValue)vkGetDeviceProcAddr(device, vkGetSemaphoreCounterValue_it)))
                break;
        if(vkGetSemaphoreCounterValue == nullptr) return false;
        ...
        for(auto vkCmdPipelineBarrier2_it : vkCmdPipelineBarrier2_strings)
            if((vkCmdPipelineBarrier2 = (PFN_vkCmdPipelineBarrier2)vkGetDeviceProcAddr(device, vkCmdPipelineBarrier2_it)))
                break;
        if(vkCmdPipelineBarrier2 == nullptr) return false;
        ...
        for(auto vkGetDeviceBufferMemoryRequirements_it : vkGetDeviceBufferMemoryRequirements_strings)
            if((vkGetDeviceBufferMemoryRequirements = (PFN_vkGetDeviceBufferMemoryRequirements)vkGetDeviceProcAddr(device, vkGetDeviceBufferMemoryRequirements_it)))
                break;
        if(vkGetDeviceBufferMemoryRequirements == nullptr) return false;
        ...
        for(auto vkGetDeviceImageMemoryRequirements_it : vkGetDeviceImageMemoryRequirements_strings)
            if((vkGetDeviceImageMemoryRequirements = (PFN_vkGetDeviceImageMemoryRequirements)vkGetDeviceProcAddr(device, vkGetDeviceImageMemoryRequirements_it)))
                break;
        if(vkGetDeviceImageMemoryRequirements == nullptr) return false;
        vkGetDeviceQueue2 = (PFN_vkGetDeviceQueue2)vkGetDeviceProcAddr(device, "vkGetDeviceQueue2");
        if(vkGetDeviceQueue2 == nullptr) return false;
        ...
        for(auto vkCmdEndRendering_it : vkCmdEndRendering_strings)
            if((vkCmdEndRendering = (PFN_vkCmdEndRendering)vkGetDeviceProcAddr(device, vkCmdEndRendering_it)))
                break;
        if(vkCmdEndRendering == nullptr) return false;
        ...
        for(auto vkCmdBeginRendering_it : vkCmdBeginRendering_strings)
            if((vkCmdBeginRendering = (PFN_vkCmdBeginRendering)vkGetDeviceProcAddr(device, vkCmdBeginRendering_it)))
                break;
        if(vkCmdBeginRendering == nullptr) return false;
        ...
        for(auto vkGetBufferDeviceAddress_it : vkGetBufferDeviceAddress_strings)
            if((vkGetBufferDeviceAddress = (PFN_vkGetBufferDeviceAddress)vkGetDeviceProcAddr(device, vkGetBufferDeviceAddress_it)))
                break;
        if(vkGetBufferDeviceAddress == nullptr) return false;
        vkCreateSwapchainKHR = (PFN_vkCreateSwapchainKHR)vkGetDeviceProcAddr(device, "vkCreateSwapchainKHR");
        if(vkCreateSwapchainKHR == nullptr) return false;
        vkDestroySwapchainKHR = (PFN_vkDestroySwapchainKHR)vkGetDeviceProcAddr(device, "vkDestroySwapchainKHR");
        if(vkDestroySwapchainKHR == nullptr) return false;
        vkGetSwapchainImagesKHR = (PFN_vkGetSwapchainImagesKHR)vkGetDeviceProcAddr(device, "vkGetSwapchainImagesKHR");
        if(vkGetSwapchainImagesKHR == nullptr) return false;
        vkAcquireNextImageKHR = (PFN_vkAcquireNextImageKHR)vkGetDeviceProcAddr(device, "vkAcquireNextImageKHR");
        if(vkAcquireNextImageKHR == nullptr) return false;
        vkQueuePresentKHR = (PFN_vkQueuePresentKHR)vkGetDeviceProcAddr(device, "vkQueuePresentKHR");
        if(vkQueuePresentKHR == nullptr) return false;
