...
wis::ImplVKDevice::CreateRootSignature(const wis::RootConstant* constants,
                                       uint32_t constants_size) const noexcept
{
    ...
    // Create descriptor set layout for binding 0 (push descriptors)
