...
public:
     ...
     * */
    [[nodiscard]] inline wis::ResultValue<wis::DX12RootSignature> CreateRootSignature(const wis::PushConstant* push_constants = nullptr, uint32_t constants_count = 0, const wis::PushDescriptor* root_descriptors = nullptr, uint32_t descriptors_count = 0, uint32_t space_overlap_count = 1) const noexcept
    {
        return wis::ImplDX12Device::CreateRootSignature(push_constants, constants_count, root_descriptors, descriptors_count, space_overlap_count);
    }
    /**
