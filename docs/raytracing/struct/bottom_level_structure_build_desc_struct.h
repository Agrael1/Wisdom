 ...
 * - `geometries` The array of geometry descriptions for the bottom-level acceleration structure. Has higher precedence
 * over `WisBottomLevelStructureBuildDesc::indirect_geometries`.
