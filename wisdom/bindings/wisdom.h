...
typedef struct WisSourceBufferRegion WisSourceBufferRegion;
typedef struct WisTextureCopyDest WisTextureCopyDest;
...
struct WisSourceBufferRegion{
    uint64_t offset;
    WisSize3D size;
};

struct WisTextureCopyDest{
    WisSize3D offset;
    uint32_t mip;
...
struct WisBufferTextureCopyRegion{
    WisSourceBufferRegion src;
    WisTextureCopyDest dst;
};
