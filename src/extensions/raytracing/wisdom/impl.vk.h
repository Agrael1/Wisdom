...
public:
    virtual bool Supported() const noexcept override { return table.vkGetAccelerationStructureBuildSizesKHR; }

public:
    [[nodiscard]] WIS_INLINE wis::RaytracingConstants GetRaytracingConstants() const noexcept;

    [[nodiscard]] WIS_INLINE wis::ASAllocationInfo GetTopLevelASSize(
        const wis::TopLevelASBuildDesc& tlas_desc
    ) const noexcept;

    [[nodiscard]] WIS_INLINE wis::ASAllocationInfo GetBottomLevelASSize(
        const wis::VKBottomLevelASBuildDesc& blas_desc
    ) const noexcept;

    [[nodiscard]] wis::VKAccelerationStructure CreateAccelerationStructure(
        wis::Result& result,
        wis::VKBufferView buffer,
        uint64_t buffer_offset,
        uint64_t structure_size,
        ASLevel structure_level
    ) const noexcept
    {
        VkAccelerationStructureCreateInfoKHR create_info{
            ...
            .size = structure_size,
            .type = structure_level == ASLevel::Top ? VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR
    ...
    [[nodiscard]] WIS_INLINE wis::VKRaytracingPipeline CreateRaytracingPipeline(
        wis::Result& result,
        const wis::VKRaytracingPipeineDesc& rt_pipeline_desc
    ) const noexcept;

    [[nodiscard]] WIS_INLINE wis::ShaderBindingTableInfo GetShaderBindingTableInfo() const noexcept { return sbt_info; }

public:
    void WIS_INLINE CopyAccelerationStructure(
    ...
    void WIS_INLINE BuildBottomLevelAS(
    ...
    void WIS_INLINE BuildTopLevelAS(
        wis::VKCommandListView cmd_buffer,
        const wis::TopLevelASBuildDesc& tlas_desc,
        wis::VKAccelerationStructureView dst_acceleration_structure,
        uint64_t scratch_buffer_gpu_address,
...
[[nodiscard]] inline constexpr wis::VKAcceleratedGeometryDesc VKCreateGeometryDesc(
