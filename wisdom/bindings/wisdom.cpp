// Generated by wisdom generator on 2024-03-12 21:53:51.4743308 GMT+1
#include "wisdom.h"
...
DX12TextureView AsDX12TextureView( self)
{
    return reinterpret_cast<DX12TextureView&>(static_cast<wis::DX12TextureView>(reinterpret_cast<wis::&>(*self)));
}
VKTextureView AsVKTextureView( self)
{
    return reinterpret_cast<VKTextureView&>(static_cast<wis::VKTextureView>(reinterpret_cast<wis::&>(*self)));
}
