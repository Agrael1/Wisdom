 ...
 * extension.
 * - `supported_initial_transitions` defines bitfield of supported initial resource state transitions for buffers and
 * textures. If a transition is supported, the corresponding bit is set to `1`, otherwise `0`. Bit positions are the
 * same as in WisTextureState enum. `WisTextureStateUndefined` is always supported. \endcond
 *
