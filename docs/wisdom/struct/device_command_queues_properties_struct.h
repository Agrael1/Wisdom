 ...
 * - `supported_queues` Array of supported queue types. If a queue type is supported, the value is `1`, otherwise `0`.
 * Order of queue types is the same as in wis::CommandQueueType enum.
 ...
 * - `max_queue_priority` Array of maximum supported priorities for each queue type. If a queue type is not supported,
 * the value is `0`. Order of queue types is the same as in wis::CommandQueueType enum. \endcond
 *
