...
enum class DescriptorType {
    ...
    Count = 7, ///< Number of descriptor types.
};
...
enum class TopologyType {
    ...
    Patch = 4, ///< Vertices are interpret as patch list. Used in tessellation process.
};
...
enum class PrimitiveRestartValue {
    ...
    UInt16Max = 1, ///< Use the maximum value of uint16_t as the primitive restart value.
    UInt32Max = 2, ///< Use the maximum value of uint32_t as the primitive restart value.
};
...
public:
     ...
     * binding.
     * @param data specifies a pointer to wis::PushConstantDataDesc, which describes the push constant data to set.
     *
     * */
     ...
     * binding.
     * @param data specifies a pointer to wis::PushDescriptorDataDesc, which describes the push descriptors to set.
     *
     * */
