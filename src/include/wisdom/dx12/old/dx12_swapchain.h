...
public:
    ...
    [[nodiscard]] uint32_t GetCurrentIndex() const noexcept { return chain->GetCurrentBackBufferIndex(); }
...
public:
     ...
     * @return Index of the current image.
     * */
    inline uint32_t GetCurrentIndex() const noexcept { return wis::ImplDX12SwapChain::GetCurrentIndex(); }
    /**
     * @brief Check if stereo is supported.
     * @return true if stereo is supported.
     * */
    inline bool StereoSupported() const noexcept { return wis::ImplDX12SwapChain::StereoSupported(); }
    /**
     * @brief Resize the swapchain.
     ...
     * */
    [[nodiscard]] inline wis::Result Present() noexcept { return wis::ImplDX12SwapChain::Present(); }
    /**
