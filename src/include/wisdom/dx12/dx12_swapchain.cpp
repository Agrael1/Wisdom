...
//-----------------------------------------------------------------------------
WIS_EXTERN_C WISDOM_API WisResult wisDX12SwapchainGetCurrentIndex(const WisDX12Swapchain* self,
                                                                  uint32_t*               index)
{
...
//-----------------------------------------------------------------------------
WIS_EXTERN_C WISDOM_API WisResult wisDX12SwapchainUpdate(const WisDX12Swapchain*       self,
