...
public:
     ...
     *
     * */
    WIS_NODISCARD inline wis::DX12Surface CreateSurface(
        const wis::Win32WindowDesc& info,
    ...
    WIS_NODISCARD inline bool Supported() noexcept {
        return (::wisDX12Win32ExtensionSupported(&_impl_storage));
    }
};
 ...
 *
 * */
class DX12UWPExtension
    : public wis::impl::Implements<wis::impl::DX12UWPExtensionImpl, WisDX12UWPExtension, wis::DX12UWPExtensionDeleter>
{
public:
 ...
 *
 * */
class VKXlibExtension
    : public wis::impl::Implements<wis::impl::VKXlibExtensionImpl, WisVKXlibExtension, wis::VKXlibExtensionDeleter>
{
public:
...
public:
     ...
     * */
    WIS_NODISCARD inline bool Supported() noexcept {
        return (::wisVKXlibExtensionSupported(&_impl_storage));
    }
};
 ...
 *
 * */
class VKXCBExtension
    : public wis::impl::Implements<wis::impl::VKXCBExtensionImpl, WisVKXCBExtension, wis::VKXCBExtensionDeleter>
{
public:
...
public:
     ...
     * */
    WIS_NODISCARD inline bool Supported() noexcept {
        return (::wisVKXCBExtensionSupported(&_impl_storage));
    }
};
...
public:
     ...
     *
     * */
    WIS_NODISCARD inline wis::VKSurface CreateSurface(
        const wis::WaylandWindowDesc& info,
        wis::Result& out_result
    ) noexcept
    {
        wis::VKSurface surface{};
     ...
     * */
    WIS_NODISCARD inline bool Supported() noexcept {
        return (::wisVKWaylandExtensionSupported(&_impl_storage));
    }
};
 ...
 *
 * */
class VKWin32Extension
    : public wis::impl::Implements<wis::impl::VKWin32ExtensionImpl, WisVKWin32Extension, wis::VKWin32ExtensionDeleter>
{
public:
...
public:
     ...
     * */
    WIS_NODISCARD inline bool Supported() noexcept {
        return (::wisVKWin32ExtensionSupported(&_impl_storage));
    }
};
