...
public:
    ...
    void EnableLoading() noexcept { EnableMenuItem(file.get(), 0, MF_BYPOSITION | MF_ENABLED); }
    void DisableLoading() noexcept { EnableMenuItem(file.get(), 0, MF_BYPOSITION | MF_DISABLED); }
