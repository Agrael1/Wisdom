...
//-----------------------------------------------------------------------------
/**
 * @brief Orders Vulkan physical device types by their expected performance, with discrete GPUs being the highest and CPUs being the lowest.
...
//-----------------------------------------------------------------------------
/**
 * @brief Orders Vulkan physical device types by their expected power efficiency, with integrated GPUs being the most power efficient and discrete GPUs being the least.
 * @param t The type of the physical device
...
wisVKCreateInstance(const WisDebugDesc*            debug_desc,
