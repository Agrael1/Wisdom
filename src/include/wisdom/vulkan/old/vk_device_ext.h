...
struct VKDeviceExtensionEmbedded1 : public QueryInternalExtension<VKDeviceExtensionEmbedded1, VKDeviceExtension> {
    ...
    ) noexcept override
    {
        ...
        if (available_extensions.contains(VK_EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT] = sizeof(
                VkPhysicalDeviceCustomBorderColorFeaturesEXT
            );
            property_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_MAINTENANCE_4_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES] = sizeof(
                VkPhysicalDeviceMaintenance4Features
            );
            property_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_MAINTENANCE_5_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES_KHR] = sizeof(
                VkPhysicalDeviceMaintenance5FeaturesKHR
            );
            property_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES_KHR] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_DYNAMIC_RENDERING_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES] = sizeof(
        ...
        if (available_extensions.contains(VK_EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_SYNCHRONIZATION_2_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_PRESENT_WAIT_EXTENSION_NAME) &&
            available_extensions.contains(VK_KHR_PRESENT_ID_EXTENSION_NAME))
        {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_FEATURES_KHR] = sizeof(
                VkPhysicalDevicePresentIdFeaturesKHR
            );
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR] = sizeof(
                VkPhysicalDevicePresentWaitFeaturesKHR
            );
        }

        if (available_extensions.contains(VK_KHR_PRESENT_WAIT_2_EXTENSION_NAME) &&
            available_extensions.contains(VK_KHR_PRESENT_ID_2_EXTENSION_NAME))
        {
            ext_name_set.insert(VK_KHR_PRESENT_ID_2_EXTENSION_NAME);
            ext_name_set.insert(VK_KHR_PRESENT_WAIT_2_EXTENSION_NAME);
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR] = sizeof(
                VkPhysicalDevicePresentId2FeaturesKHR
            );
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR] = sizeof(
        ...
        if (available_extensions.contains(VK_EXT_SWAPCHAIN_MAINTENANCE_1_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_EXT] = sizeof(
        ...
        if (available_extensions.contains(VK_EXT_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_EXTENSION_NAME)) {
            ...
            structure_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_FEATURES_EXT] = sizeof(
        ...
        if (available_extensions.contains(VK_KHR_PUSH_DESCRIPTOR_EXTENSION_NAME)) {
            ...
            property_map[VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR] = sizeof(
    ...
    {
        return features.swapchain && features.synchronization_2 && features.dynamic_rendering &&
               features.push_descriptor;
    }

    // Not supposed to use device here.
    virtual wis::Result Init(
        const wis::VKDevice& device,
        const std::unordered_map<VkStructureType, uintptr_t>& structure_map,
        const std::unordered_map<VkStructureType, uintptr_t>& property_map
    ) noexcept override
    {
        auto& vk_physical_device_properties = *reinterpret_cast<VkPhysicalDeviceProperties2*>(
            property_map.at(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2)
        );
        base_properties.max_ia_attributes = vk_physical_device_properties.properties.limits.maxVertexInputAttributes;

        auto& vk_11_features = *reinterpret_cast<VkPhysicalDeviceVulkan11Features*>(
            structure_map.at(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES)
        );
        features.multiview = vk_11_features.multiview;

        // Check present wait 2 support
        {
            auto& vk_present_wait_2_features = *reinterpret_cast<VkPhysicalDevicePresentWait2FeaturesKHR*>(
                structure_map.at(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR)
            );
        ...
        {
            auto& vk_present_wait_features = *reinterpret_cast<VkPhysicalDevicePresentWaitFeaturesKHR*>(
                structure_map.at(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR)
            );
            features.present_wait = vk_present_wait_features.presentWait == VK_TRUE;
        }

        features.raytracing = structure_map.contains(
            VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR
        );
        return {};
    }

    XInternalFeatures GetFeatures() const noexcept { return features; }
};
} // namespace wis
